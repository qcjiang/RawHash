...
uncalled pafstats -r ../true_mappings.paf --annotate ../rawhash2_vote/d3_yeast_r94_rawhash2_sensitive.paf > d3_yeast_r94_rawhash2_vote_sensitive_ann.paf 2> d3_yeast_r94_rawhash2_vote_sensitive.throughput
uncalled pafstats -r ../true_mappings.paf --annotate ../rawhash2_vote/d3_yeast_r94_w3_rawhash2_sensitive.paf > d3_yeast_r94_w3_rawhash2_vote_sensitive_ann.paf 2> d3_yeast_r94_w3_rawhash2_vote_sensitive.throughput

python ../../../../scripts/compare_pafs.py d3_yeast_r94_uncalled_ann.paf d3_yeast_r94_sigmap_ann.paf d3_yeast_r94_rawhash_sensitive_ann.paf d3_yeast_r94_rawhash2_sensitive_ann.paf d3_yeast_r94_rawhash2_vote_sensitive_ann.paf > d3_yeast_r94_rawhash2_sensitive.comparison
python ../../../../scripts/compare_pafs.py d3_yeast_r94_uncalled_ann.paf d3_yeast_r94_sigmap_ann.paf d3_yeast_r94_rawhash_sensitive_ann.paf d3_yeast_r94_w3_rawhash2_sensitive_ann.paf d3_yeast_r94_w3_rawhash2_vote_sensitive_ann.paf > d3_yeast_r94_w3_rawhash2_sensitive.comparison
